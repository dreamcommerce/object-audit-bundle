...
final class AuditCollection implements Collection
{
    /**
    ...
    {
        throw CollectionException::readOnly(__CLASS__);
    }
    ...
    public function offsetGet($offset)
    {
        ...
        if (!isset($this->objects[$offset])) {
            throw CollectionException::forNotDefinedOffset(__CLASS__, $offset);
        }
