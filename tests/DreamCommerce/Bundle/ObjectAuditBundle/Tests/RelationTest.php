...
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\AbstractDataEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\Category;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\CheeseProduct;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\ChildEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\DataContainerEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\DataLegalEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\DataPrivateEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\FoodCategory;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OneToOneAuditedEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OneToOneMasterEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OneToOneNotAuditedEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OwnedEntity1;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OwnedEntity2;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OwnedEntity3;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\OwnerEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\Page;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\PageAlias;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\PageLocalization;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\Product;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\RelatedEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\RelationFoobarEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\RelationOneToOneEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\RelationReferencedEntity;
use DreamCommerce\Bundle\ObjectAuditBundle\Tests\Fixtures\Relation\WineProduct;
